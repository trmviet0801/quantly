...
type Income struct {
	...
	InterestExpenseNonOperating                         float64 `json:"interest_expense_non_operating"`
	...
	OtherNonOperatingIncomeExpense                      float64 `json:"other_non_operating_income_expense"`
	...
	NormalizedEbitda                                    float64 `json:"normalized_ebitda"`
